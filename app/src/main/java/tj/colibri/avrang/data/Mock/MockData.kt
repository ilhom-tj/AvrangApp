...
//    //tj.colibri.avrang.data.ApiData.productinfo.tj.colibri.avrang.models.product.tj.colibri.avrang.models.product.ProductInfo.Product
...
//        product4)
    ...
    //tj.colibri.avrang.models.home.tj.colibri.avrang.data.ApiData.tj.colibri.avrang.models.product.ProductInfo.Category.tj.colibri.avrang.models.Category.Categories and subcategories
...
//    val listOfCartItems = mutableListOf(cartItem1, cartItem2, cartItem3, cartItem4)
   ...
   // private var filterRadio6 = FilterRadioButton(6,"По скидкам","Сначала товары с большим % скидки")
    ...
    val attr1 = Attributes("lala","lala")

    val attr2 = Attributes("lala","lala")
    val attr3 = Attributes("lala","lala")

    val attr4 = Attributes("lala","lala")

    val attr5 = Attributes("lala","lala")

    val attr6 = Attributes("lala","lala")

    val attr7 = Attributes("lala","lala")
    val listAttr = listOf<Attributes>(attr1, attr2,attr3,attr4,attr5,attr6,attr7)
