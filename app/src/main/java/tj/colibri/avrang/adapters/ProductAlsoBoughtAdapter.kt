...
class ProductAlsoBoughtAdapter(val context : Fragment,
                         private val itemClickListener: ItemClicked
) : RecyclerView.Adapter<ProductAlsoBoughtAdapter.ProductHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ProductAlsoBoughtAdapter.ProductHolder {
    ...
    override fun onBindViewHolder(holder: ProductAlsoBoughtAdapter.ProductHolder, position: Int) {
